...
const Payment = () => {
  ...
  const [paymentMethod, setPaymentMethod] = useState<string>('jazzcash'); // Use backend value
  ...
  const createPaymentRecord = async (paymentId: string) => {
    try {
      ...
      const paymentData = {
        ...
        method: paymentMethod, // Now using the backend value
        status: 'pending',
      };
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      // Navigate to PaymentDetails screen with all necessary parameters
      router.push({
        ...
        params: { 
          ...
          paymentMethod: paymentMethodLabel, // Send display name to next screen
    ...
    <TouchableWithoutFeedback onPress={() => {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.buttonContainer}>
          <MyButton 
            title={processing ? "Processing..." : `Pay Rs. ${driverPayment || estimatedPrice}`} 
...
const styles = StyleSheet.create({
  ...
  driverPaymentText: {
    ...
    marginTop: 10,
    marginBottom: 10,
    color: '#4CAF50', // Green color for driver payment
    textAlign: 'center',
  },
