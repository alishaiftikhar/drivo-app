...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://192.168.100.7:8081",  # Added for React Native
    "exp://localhost:19000",      # Added for Expo
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'drivodb'),
...
API_BASE_URL = os.getenv('API_BASE_URL', 'http://192.168.100.7:8000')
